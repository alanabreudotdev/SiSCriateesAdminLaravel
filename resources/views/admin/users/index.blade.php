                            ...
                            <table class="table">
                                ...
                                @foreach($users as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/users/' . $item->id) }}" title="Ver Usuário"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                            <a href="{{ url('/admin/users/' . $item->id . '/edit') }}" title="Editar Usuário"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                            {!! Form::open([
                                                'method' => 'DELETE',
