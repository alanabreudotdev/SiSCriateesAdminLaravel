...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Gerador SiSCriatees</div>
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" method="post" action="{{ url('/admin/generator') }}">
                            ...
                            <div class="form-group row">
                                <label for="crud_name" class="col-md-4 col-form-label text-right">Crud Nome:</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="route" class="col-md-4 col-form-label text-right">Quer add rota?</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="relationships" class="col-md-4 col-form-label text-right">Relacionamentos</label>
                                <div class="col-md-6">
                                    <input type="text" name="relationships" class="form-control" id="relationships" placeholder="comments#hasMany#App\Comment">
                                    <p class="help-block">método#relaçãoTipo#Model</p>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="soft_deletes" class="col-md-4 col-form-label text-right">Quer usar soft deletes?</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group table-fields">
                                <h4 class="text-center">Campos da Tabela:</h4><br>
                            ...
                            <div class="form-group row">
                                <div class="offset-md-4 col-md-4">
                                    <button type="submit" class="btn btn-primary" name="generate">Gerar</button>
                                </div>
                            </div>
                        </form>
